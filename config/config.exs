...
config :test_child_liveview_event,
  ecto_repos: [TestChildLiveviewEvent.Repo]
...
config :test_child_liveview_event, TestChildLiveviewEventWeb.Endpoint,
  ...
  live_view: [signing_salt: "Ms/YEXsI"]
...
config :test_child_liveview_event, TestChildLiveviewEvent.Mailer, adapter: Swoosh.Adapters.Local
